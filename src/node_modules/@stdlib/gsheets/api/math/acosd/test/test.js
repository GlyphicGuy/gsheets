...
var ref = require( '@stdlib/math-base-special-acosd' );
...
tape( 'the function computes the arccosine (in degrees) of a double-precision floating-point number (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the arccosine (in degrees) of a double-precision floating-point number (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
