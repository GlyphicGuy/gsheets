...
> Compute the inverse cotangent of a number (in degrees).
...
```javascript
var acotd = require( '@stdlib/gsheets/api/math/acotd' );
```

#### acotd( value\[, nonnumeric, nonnumericValue, nan, nanValue, pinf, pinfValue, ninf, ninfValue] )
