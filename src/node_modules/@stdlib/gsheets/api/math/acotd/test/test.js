...
var ref = require( '@stdlib/math-base-special-acotd' );
...
tape( 'the function computes the inverse cotangent of a number (in degrees) (primitive)', function test( t ) {
	var expected;
	var actual;
	var v;
	var i;
...
tape( 'the function computes the inverse cotangent of a number (in degrees) (nested array)', function test( t ) {
	var expected;
	var actual;
	var arr;
	var tmp;
